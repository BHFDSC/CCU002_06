...
# MAGIC %md # ccu002_06-D06-quality_assurance
# MAGIC  
...
# MAGIC
# MAGIC SI temporarily set ccu002_06_codelists to CCU002_03_codelists since former not completed. The relevant codes should be identical.
...
# MAGIC final_table = 'ccu002_06_conflictingpatients'
...
create_table(df_gdppr_sex, table_name="ccu002_06_df_gdppr_sex")
...
# MAGIC %sql
# MAGIC describe extended dars_nic_391419_j3w9t_collab.ccu002_06_df_gdppr_sex
...
df_gdppr = spark.table("dars_nic_391419_j3w9t_collab.ccu002_06_df_gdppr_sex") # created for rule 6, no need to re-do
