...
# MAGIC %md # ccu002_06-D04-custom_tables
# MAGIC  
...
# MAGIC %sql
# MAGIC CREATE OR REPLACE GLOBAL TEMP VIEW ccu002_06_hes_apc_longformat AS
# MAGIC SELECT *
...
drop_table('ccu002_06_hes_apc_longformat')
create_table('ccu002_06_hes_apc_longformat')

# COMMAND ----------

# MAGIC %sql 
# MAGIC DESCRIBE EXTENDED dars_nic_391419_j3w9t_collab.ccu002_06_hes_apc_longformat
...
# MAGIC %sql
# MAGIC CREATE OR REPLACE GLOBAL TEMP VIEW ccu002_06_hes_apc_opertn_longformat_tmp AS
# MAGIC SELECT *
# MAGIC FROM (SELECT PERSON_ID_DEID AS NHS_NUMBER_DEID, 
# MAGIC              ADMIDATE, 
# MAGIC              DISDATE,
...
drop_table('ccu002_06_hes_apc_opertn_longformat_tmp')
create_table('ccu002_06_hes_apc_opertn_longformat_tmp')

# COMMAND ----------

# MAGIC %sql
# MAGIC describe extended dars_nic_391419_j3w9t_collab.ccu002_06_hes_apc_opertn_longformat_tmp
...
# MAGIC %sql
# MAGIC CREATE OR REPLACE GLOBAL TEMP VIEW ccu002_06_deaths_longformat AS
# MAGIC SELECT *
...
# MAGIC FROM dars_nic_391419_j3w9t_collab.ccu002_06_deaths_dars_nic_391419_j3w9t)
# MAGIC WHERE NHS_NUMBER_DEID IS NOT NULL AND DATE IS NOT NULL AND CODE IS NOT NULL

# COMMAND ----------

drop_table('ccu002_06_deaths_longformat')
create_table('ccu002_06_deaths_longformat')
...
# MAGIC %sql
# MAGIC CREATE OR REPLACE GLOBAL TEMP VIEW ccu002_06_sus_longformat AS
...
# MAGIC FROM dars_nic_391419_j3w9t_collab.ccu002_06_sus_dars_nic_391419_j3w9t

# COMMAND ----------

drop_table('ccu002_06_sus_longformat')
create_table('ccu002_06_sus_longformat')
...
# MAGIC CREATE OR REPLACE GLOBAL TEMP VIEW ccu002_06_lsoa_region_lookup AS
# MAGIC with 
...
drop_table('ccu002_06_lsoa_region_lookup')
create_table('ccu002_06_lsoa_region_lookup')

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM dars_nic_391419_j3w9t_collab.ccu002_06_lsoa_region_lookup

# COMMAND ----------

# MAGIC %md ## COVID19 tractory table 
# MAGIC SI ran using ccu013_covid_trajectory table created on 21.01.2022

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE OR REPLACE GLOBAL TEMP VIEW ccu002_06_ccu013_covid_trajectory AS
...
drop_table('ccu002_06_ccu013_covid_trajectory')
create_table('ccu002_06_ccu013_covid_trajectory')

# COMMAND ----------

# MAGIC %sql
# MAGIC describe extended dars_nic_391419_j3w9t_collab.ccu002_06_ccu013_covid_trajectory

# COMMAND ----------

# MAGIC %sql
# MAGIC describe extended dars_nic_391419_j3w9t_collab.ccu013_covid_trajectory
# MAGIC -- Created Time: Fri Jan 21 18:50:49 UTC 2022 (checked 09 May 2022)
