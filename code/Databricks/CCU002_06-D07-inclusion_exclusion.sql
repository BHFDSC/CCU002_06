...
-- MAGIC gdppr_data = '.ccu002_06_gdppr_'
-- MAGIC skinny_data = '.ccu002_06_skinny_patient'
-- MAGIC death_data = '.ccu002_06_deaths_'
-- MAGIC sgss_data = '.ccu002_06_sgss_'
-- MAGIC
-- MAGIC #Other data inputs
-- MAGIC conflicting_quality_assurance = '.ccu002_06_conflictingpatients'
-- MAGIC
...
---%md %run "/Workspaces//ccu002_06c/Data_Curation/in_progress/CCU002-D03-quality_assurance_parameters_new"
...
SELECT t1.*
FROM skinny t1
LEFT JOIN .ccu002_06_conflictingpatients t2 ---those who didnt meet QA criteria, from the previous notebook
...
-- MAGIC %sql 
-- MAGIC describe extended .ccu002_06_included_patients
