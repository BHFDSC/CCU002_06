...
def drop_create_table(table_name:str, save2database_name:str=''):
...
new_collab_database_name=''

codelist_table='codelists'
gdppr_data = 'gdppr_'
hes_apc_data = 'hes_apc_all_years'
pcmeds_data = 'primary_care_meds_'
...
# fpaths_vars_all_pcmeds = ".ccu002_06_cvflag_" +vars_binary_pcmeds +"_pcmeds"
