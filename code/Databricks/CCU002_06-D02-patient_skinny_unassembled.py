...
# MAGIC %md # CCU002_06-D02-patient_skinny_unassembled
# MAGIC
# MAGIC **Description** Gather together the records for each patient in primary and secondary care before they are assembled into a skinny record for CCU002. The output of this is a global temp View which is then used by **CCU002_06-D03-patient_skinny_record**
# MAGIC  
...
#Datasets
hes_apc_data = 'CCU002_06_hes_apc_all_years'
hes_op_data = 'CCU002_06_hes_op_all_years'
hes_ae_data = 'CCU002_06_hes_ae_all_years'
gdppr_data = 'CCU002_06_gdppr_dars_nic_391419_j3w9t'
deaths_data = 'CCU002_06_deaths_dars_nic_391419_j3w9t'
...
# %sql 
# SELECT * FROM global_temp.curr301_patient_skinny_unassembled

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT distinct(dataset)
# MAGIC FROM global_temp.curr301_patient_skinny_unassembled

# COMMAND ----------

# %sql
# SELECT distinct(care_domain)
# FROM global_temp.curr301_patient_skinny_unassembleded 

# COMMAND ----------

# %sql
# DESCRIBE EXTENDED dars_nic_391419_j3w9t_collab.ccu002_deaths_dars_nic_391419_j3w9t
